...
// Only allow the real frontend and local development origins.
...
app.use(cors({
  origin: (origin, callback) => {
    // Requests without an Origin header are normally server-to-server/health checks.
...
app.get('/', (req, res) => {
  res.send('Resumn API is operating normally.');
});
...
app.listen(PORT, () => {
  console.log(`Resumn API running on port ${PORT}`);
});
