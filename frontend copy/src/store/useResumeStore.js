...
//         // 🚀 CTO FIX: Dynamically wire up the newly found custom sections (Coursework, Leadership)
...
//         delete finalData.customSections; // Clean up payload
...
//       alert(err?.response?.data?.error || err.message || 'Failed to analyze resume.');
//     } finally {
//       set({ isTailoring: false });
//     }
//   },
