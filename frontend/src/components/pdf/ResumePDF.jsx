...
//     const marginsMap = { compact: '0.3in', standard: '0.4in', spacious: '0.5in' };
//     const lineSpacingMap = { tight: 1.1, standard: 1.2, loose: 1.4 };
...
//         },
//         layout: {
//             padding: marginsMap[docStyle?.margins] || '0.4in',
//             lineHeight: lineSpacingMap[docStyle?.lineSpacing] || 1.2
//         }
//     };
// };
...
//     return (
//         <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: alignVal, marginTop: 4, marginBottom: 6 }}>
...
//         headerText: { textAlign: 'center', marginBottom: 8 },
//         name: { fontFamily: config.fonts.bold, fontSize: config.fonts.h1, textTransform: 'uppercase', marginBottom: 4, lineHeight: 1 },
//         sectionTitle: { fontFamily: config.fonts.bold, fontSize: config.fonts.h2, textTransform: 'uppercase', borderTopWidth: 1, borderTopColor: '#000', borderBottomWidth: 1, borderBottomColor: '#000', paddingVertical: 2, marginBottom: 6, marginTop: 10, textAlign: 'center' },
...
//         name: { fontFamily: config.fonts.bold, fontSize: config.fonts.h1, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4, lineHeight: 1 },
...
//         name: { fontFamily: config.fonts.bold, fontSize: config.fonts.h1, marginBottom: 4, lineHeight: 1 },
